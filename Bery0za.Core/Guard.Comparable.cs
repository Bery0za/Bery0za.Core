    ...
    public static partial class Guard
    {
            ...
            where T : IComparable<T>
        {
            if (value.CompareTo(min) <= 0 || value.CompareTo(max) >= 0)
                throw new ArgumentException(message ?? $"{value} must be in range ({min}; {max}).");
        }
        ...
        {
            if (a.CompareTo(b) != 0)
                throw new ArgumentException(message ?? $"{nameof(a)} is not equal to {nameof(b)}.");
        }
        ...
        {
            if (a.CompareTo(b) <= 0)
                throw new ArgumentException(message ?? $"{nameof(a)} is less than {nameof(b)} or equal.");
        }
        ...
        {
            if (a.CompareTo(b) >= 0)
                throw new ArgumentException(message ?? $"{nameof(a)} is greater than {nameof(b)} or equal.");
        }
